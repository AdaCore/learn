.. code:: ada project=Training_Material.Fundamentals_Of_Ada.Expressions.subtypes
    :class: ada-run
   ...
   procedure Subtypes is
      ...
      Weekday      : Weekdays_T;
      Also_Weekday : Days_T range Mon .. Fri;
      Day          : Days_T := Weekday;
      ...
      type Tertiary_Switch is (Off, On, Neither) with Default_Value => Neither;
