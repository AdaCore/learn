.. code:: ada project=Training_Material.Fundamentals_Of_Ada.Array_Types.attributes
    :class: ada-run
   ...
   procedure Attributes is
      ...
      type Array_Of_Bitstrings_T is array (Natural range <>, Natural range <>) of Boolean;
