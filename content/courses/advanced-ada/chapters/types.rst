...
:ada:`Valid` aspect. For example, if we have a variable :ada:`Var`, we can
...
In summary, using the :ada:`Valid` aspect is a good strategy we can employ when
we know that information stored in memory might be corrupted.
